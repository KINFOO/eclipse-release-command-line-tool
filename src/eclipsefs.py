...
class EclipseFS:
    ...
    def __init__(self, root=None):
        ...
        # Download constant
        self.DOWNLOAD_ROOT_DIRECTORY = os.path.join(root,'home/data/httpd/download.eclipse.org/ldt/')
        ...
        self.SHARED_PRODUCTS_FOLDER = self.SHARED_LDT_FOLDER + "products/"
        self.NIGHTLY_PRODUCTS_DIRECTORY = self.SHARED_PRODUCTS_FOLDER + "nightly"
        self.NIGHTLY_MAINTENANCE_PRODUCTS_DIRECTORY = self.SHARED_PRODUCTS_FOLDER + "nightly-maintenance"
        
        # Archive constant
        self.ARCHIVE_ROOT_DIRECTORY = os.path.join(root,'home/data/httpd/archive.eclipse.org/ldt/')
